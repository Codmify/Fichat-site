    ...
    return (
        <section className="bg-[#262626]  text-[#8f9198] rounded-lg">
            <header className="flex justify-between items-center py-2 px-4 border-b-[0.25px] border-[rgba(143,145,152,0.6)]">
                <h2 className="text-md text-[#8f9198] font-[700] my-3">Create New Group</h2>
                <button
            ...
            <form>
                <div className="p-6 flex flex-col gap-y-4 border-b-[0.25px] border-[rgba(143,145,152,0.6)]">
                    <div>
                        <label htmlFor="group" className="font-[600]">Group Name</label>
                        <input
                            type="text"
                            id="group"
                            name="group"
                    ...
                    <div>
                        <label htmlFor="message" className="font-[600]">Description</label>
                        <textarea
                            id="message"
                            name="message"
                            value={textarea}
