...
const ChatModal = () => {
    ...
    return (
        <>
            <section className='absolute left-0 top-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50 z-40' onClick={closeModal}></section>
            <div className="w-full sm:w-[600px] sm:left-[12%] absolute left-0 md:left-[30%] top-[12%] transition-top duration-900 flex justify-center items-center z-50">
